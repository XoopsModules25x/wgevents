...
\define('_MI_WGEVENTS_INDEX_DISPLAYTYPE', 'Anzeige auf Index-Seite');
\define('_MI_WGEVENTS_INDEX_DISPLAYTYPE_DESC', 'Bitte definiere wie die nächsten Veranstaltungen auf der Indexseite dargestellt werden sollen');
\define('_MI_WGEVENTS_INDEX_DISPLAYTYPE_LIST', 'Liste');
\define('_MI_WGEVENTS_INDEX_DISPLAYTYPE_CARDS', 'Bootstrap Cards');
