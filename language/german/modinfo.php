...
\define('_MI_WGEVENTS_ADMENU3', 'Zusatzinfos');
...
\define('_MI_WGEVENTS_ADMENU8', 'Typen Zusatzinfos');
...
\define('_MI_WGEVENTS_USE_REGISTER_HIST', 'Anmeldungshistorie verwenden');
\define('_MI_WGEVENTS_USE_REGISTER_HIST_DESC', 'Daten der Anmeldung vor den Löschen oder Aktualisieren in einer Historietabelle speichern');
\define('_MI_WGEVENTS_USE_LOGS', 'Logs erstellen');
