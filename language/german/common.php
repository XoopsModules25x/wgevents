...
\define('CO_' . $moduleDirNameUpper . '_HELP_HEADER', __DIR__ . '/help/help
header.tpl');
...
\define('CO_' . $moduleDirNameUpper . '_' . 'SAVE_SAMPLEDATA_ERROR', 'Fehler: Export Tabellen nach YAML fehlgeschlagen');
