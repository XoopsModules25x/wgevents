...
\define('_AM_WGEVENTS_THEREARE_QUESTIONS', "Es gibt <span class='bold'>%s</span> Zusatzinfos in der Datenbank");
...
\define('_AM_WGEVENTS_THEREARENT_QUESTIONS', "Es gibt keine Zusatzinfos");
