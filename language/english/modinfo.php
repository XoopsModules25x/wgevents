...
\define('_MI_WGEVENTS_ADMENU2', 'Event');
\define('_MI_WGEVENTS_ADMENU3', 'Question');
\define('_MI_WGEVENTS_ADMENU4', 'Answer');
\define('_MI_WGEVENTS_ADMENU5', 'Registration');
\define('_MI_WGEVENTS_ADMENU6', 'Textblock');
\define('_MI_WGEVENTS_ADMENU7', 'Category');
\define('_MI_WGEVENTS_ADMENU8', 'Types Question');
...
\define('_MI_WGEVENTS_ADMENU13', 'Log');
\define('_MI_WGEVENTS_ADMENU14', 'Email Account');
...
\define('_MI_WGEVENTS_EVENTS_BLOCK_LAST_DESC', 'Event block last description');
\define('_MI_WGEVENTS_EVENTS_BLOCK_NEW', 'Event block new');
\define('_MI_WGEVENTS_EVENTS_BLOCK_NEW_DESC', 'Event block new description');
...
\define('_MI_WGEVENTS_EVENTS_BLOCK_RANDOM_DESC', 'Event block random description');
\define('_MI_WGEVENTS_EVENTS_BLOCK_SPOTLIGHT', 'Event block spotlight');
\define('_MI_WGEVENTS_EVENTS_BLOCK_SPOTLIGHT_DESC', 'Event block spotlight description');
// Config
