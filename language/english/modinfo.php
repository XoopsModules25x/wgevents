...
\define('_MI_WGEVENTS_INDEX_DISPLAYTYPE', 'Display type on index page');
\define('_MI_WGEVENTS_INDEX_DISPLAYTYPE_DESC', 'Please define how you want to displayed next events on index page');
\define('_MI_WGEVENTS_INDEX_DISPLAYTYPE_LIST', 'List');
