...
\define('_MI_WGEVENTS_ADMENU12', 'Answers History');
...
\define('_MI_WGEVENTS_SMNAME3', 'Submit Events');
\define('_MI_WGEVENTS_SMNAME4', 'Registrations');
\define('_MI_WGEVENTS_SMNAME5', 'Show my Registrations');
\define('_MI_WGEVENTS_SMNAME6', 'Calendar');
//\define('_MI_WGEVENTS_SMNAME7', 'Submit Answers');
\define('_MI_WGEVENTS_SMNAME8', 'Textblocks');
//\define('_MI_WGEVENTS_SMNAME9', 'Submit Textblocks');
\define('_MI_WGEVENTS_SMNAME10', 'Show my Events');
\define('_MI_WGEVENTS_SMNAME15', 'Search');
// Blocks
//\define('_MI_WGEVENTS_EVENTS_BLOCK', 'Events block');
//\define('_MI_WGEVENTS_EVENTS_BLOCK_DESC', 'Events block description');
//\define('_MI_WGEVENTS_EVENTS_BLOCK_EVENT', 'Events block  EVENT');
//\define('_MI_WGEVENTS_EVENTS_BLOCK_EVENT_DESC', 'Events block  EVENT description');
\define('_MI_WGEVENTS_EVENTS_BLOCK_LAST', 'Events block last');
\define('_MI_WGEVENTS_EVENTS_BLOCK_LAST_DESC', 'Events block last description');
\define('_MI_WGEVENTS_EVENTS_BLOCK_NEW', 'Events block new');
\define('_MI_WGEVENTS_EVENTS_BLOCK_NEW_DESC', 'Events block new description');
...
//\define('_MI_WGEVENTS_EVENTS_BLOCK_TOP', 'Events block top');
//\define('_MI_WGEVENTS_EVENTS_BLOCK_TOP_DESC', 'Events block top description');
\define('_MI_WGEVENTS_EVENTS_BLOCK_RANDOM', 'Events block random');
\define('_MI_WGEVENTS_EVENTS_BLOCK_RANDOM_DESC', 'Events block random description');
\define('_MI_WGEVENTS_EVENTS_BLOCK_SPOTLIGHT', 'Events block spotlight');
\define('_MI_WGEVENTS_EVENTS_BLOCK_SPOTLIGHT_DESC', 'Events block spotlight description');
// Config
...
\define('_MI_WGEVENTS_USE_REGISTER_HIST', 'Use registration history');
\define('_MI_WGEVENTS_USE_REGISTER_HIST_DESC', 'Save data of registrations in a history before updating or deleting');
\define('_MI_WGEVENTS_USE_LOGS', 'Create Logs');
